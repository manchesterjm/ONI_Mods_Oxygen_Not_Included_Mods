...
{
    // Bigger Camera Zoom Out (Cairath, Steam 1717463209). Revived from the Cairath
    // GitHub source (last touched Nov 2022) and rebuilt for build 737790. Raises the
    // camera's max orthographic size to 200 (default 20), removes the world-bounds
    // zoom constraint, and lets the cluster/starmap zoom out further. Only change vs
    // the original is dropping the CaiLib logger; all five patches verified against
    // Assembly-CSharp.dll @737790.
